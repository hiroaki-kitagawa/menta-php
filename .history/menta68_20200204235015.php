...
class Human extends HumanBase {
    ...
    public function setHuman($first_name, $middle_name, $last_name, $age)
    {
        ...
        $this->middle_name = $middle_name; // ミドルネーム追加
    ...
    public function getFullName()
    {
        if (isset($this->middle_name)){
            return $this->first_name . '-' . $this->middle_name . '-' . $this->last_name . PHP_EOL;
        } else {
...
$sato = new Human();
$sato->setHuman('ジョン', 'フィッツジェラルド', 'ケネディ', 46);
echo $sato->getFullName();
